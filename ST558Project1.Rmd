...
sa <- Getdayone('south-africa', 'confirmed')
saL <- GetdayoneLive('south-africa','confirmed', TRUE)
saNL <- GetdayoneLive('south-africa','confirmed',FALSE)
...
```{r filter data, echo=TRUE, eval=TRUE}
...
```{r scatterplotnew, echo=TRUE, eval=TRUE}
